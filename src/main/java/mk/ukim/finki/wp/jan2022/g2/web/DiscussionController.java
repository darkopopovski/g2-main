...
public class DiscussionController {
    ...
    public String showList(@RequestParam(required = false) Long participantId, @RequestParam(required = false) Integer daysUntilClosing, Model model) {
        List<Discussion> discussions = service.listAll();
    ...
    model.addAttribute("discussions", this.service.listAll());
    model.addAttribute("tags",DiscussionTag.values());
        return "form";
    }
    ...
    public String showEdit(@PathVariable Long id, Model model) {
        model.addAttribute("discussionsToEdit",this.service.findById(id));
        model.addAttribute("users",userService.listAll());
        model.addAttribute("tags",DiscussionTag.values());
        return "form";
    }
     ...
     * @return The view "list.html".
     */
    @PostMapping("/discussions/{id}/mark")
